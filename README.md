...
### 候位登記功能暫時關閉
**生效日期**: 2024年12月  
**變更說明**: 候位登記功能已暫時調整為僅管理員可用，一般訪客無法直接進行候位登記。  
**功能位置**: 
- 管理員後台新增「登記候位」浮動視窗功能
- 保留完整的候位登記表單和驗證邏輯
- 日後可根據需求重新開放給公眾使用
...
**技術實施**:
- 首頁和導航欄的"我要候位"按鈕僅登入管理員可見
- `/register` 路由需要管理員認證才能訪問
- 所有原有功能架構完整保留，便於快速重新開放

**管理員操作方式**:
1. 登入管理後台
2. 點擊候位管理頁面的「登記候位」按鈕（綠色，使用PersonAddIcon）
3. 在浮動視窗中完成客戶候位登記
4. 登記完成後自動更新候位列表

...
exports.updateQueueData = async (req, res) => {
  try {
    ...
    console.log('後端接收到前端已處理的數據，直接儲存:', {
      gregorianBirthYear: updateData.gregorianBirthYear,
      lunarBirthYear: updateData.lunarBirthYear,
      virtualAge: updateData.virtualAge
    });

    ...
    if (selectedRecord && editMode) {
      ...
      if (hasGregorianChanged && hasLunarChanged) {
        ...
        if (processedData.lunarBirthYear && processedData.lunarBirthMonth && processedData.lunarBirthDay) {
          ...
          console.log('=== AdminDashboard 農曆年份處理調試 ===');
        ...
        processedData.familyMembers = processedData.familyMembers.map((member, index) => {
          ...
          if (hasMemberGregorianChanged && hasMemberLunarChanged) {
            ...
            if (processedMember.lunarBirthYear && processedMember.lunarBirthMonth && processedMember.lunarBirthDay) {
              // 農曆年份也使用民國年輸入，完全仿效登記功能的處理方式
              console.log('=== AdminDashboard 家人農曆年份處理調試 ===');
              ...
              const { minguoYear: memberMinguoYear } = autoConvertToMinguo(inputYear);
              console.log('判斷為民國年:', memberMinguoYear);
              
              const memberGregorianFormatLunarYear = convertMinguoForStorage(memberMinguoYear);
              console.log('轉換為西元年:', memberGregorianFormatLunarYear);
              
              processedMember.lunarBirthYear = memberGregorianFormatLunarYear;
              ...
              console.log('最終AdminDashboard家人農曆數據:', {
